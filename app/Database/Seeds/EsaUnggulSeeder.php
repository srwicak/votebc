    ...
    public function run()
    {
        ...
        $users = [
            ...
            [
                ...
                'is_super_admin' => 0,
                'status'         => 'active',
                'faculty_id'     => 2, // FASILKOM
                'department_id'  => 4, // Teknik Informatika
                'created_at'     => date('Y-m-d H:i:s'),
                'updated_at'     => date('Y-m-d H:i:s'),
            ],
            [
            ...
            [
                ...
                'status'         => 'active',
                'faculty_id'     => 5,  // FIKOM
                'department_id'  => 12, // Ilmu Komunikasi
                'created_at'     => date('Y-m-d H:i:s'),
                'updated_at'     => date('Y-m-d H:i:s'),
            ],
            [
                'nim'            => '20230009',
                'name'           => 'Tono Saputra',
                'password'       => password_hash('password9', PASSWORD_DEFAULT),
                'role'           => 'mahasiswa',
                'is_super_admin' => 0,
                'status'         => 'active',
                'faculty_id'     => 5,
            ...
            [
                'nim'            => '20230010',
                'name'           => 'Maya Sari',
                'password'       => password_hash('password10', PASSWORD_DEFAULT),
                'role'           => 'mahasiswa',
                'is_super_admin' => 0,
                'status'         => 'active',
                'faculty_id'     => 6,  // FKIP
                'department_id'  => 14, // Pendidikan Guru Sekolah Dasar
                'created_at'     => date('Y-m-d H:i:s'),
                'updated_at'     => date('Y-m-d H:i:s'),
            ],
        ];
